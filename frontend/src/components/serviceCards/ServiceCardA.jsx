    ...
    >
      ...
      <div className="relative z-10 grid grid-cols-[1fr_1.05fr] gap-0 px-6 mt-4" dir="rtl">
        ...
        >
          ...
          <div
            ...
            onMouseLeave={(e) => {
              ...
              e.currentTarget.style.borderColor = "rgba(214,167,86,0.55)";
            }}
            onMouseDown={(e) => {
        ...
        >
          ...
          <div className="relative z-10 h-full flex flex-col justify-between p-4 pb-24">
      ...
      {/* فاصل */}
      <div className="px-6 mt-20" aria-hidden>
        <div
